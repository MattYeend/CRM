...
use App\Policies\PartSerialNumberPolicy;
use App\Policies\PartStockMovementPolicy;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->booted(function () {
        ...
        */
        ...
        Gate::policy(PartSerialNumber::class, PartSerialNumberPolicy::class);
        Gate::policy(PartStockMovement::class, PartStockMovementPolicy::class);
