...
/**
 * Provides query scope methods for the User model, allowing for easy filtering
 * of users based on their roles and test status. This trait is intended to be
 * used within the User model to encapsulate common query scopes related to user
