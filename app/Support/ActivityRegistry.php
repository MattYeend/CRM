...
/**
 * Registry of entities that can have activity tracked against them.
 *
 * Central definition of activity-enabled entity types with labels
 * and API endpoints.
 */
class ActivityRegistry
{
    /**
     * Get all activity-enabled entity types with metadata.
     *
     * Each entry contains:
    ...
    /**
     * Get all activity registry keys.
     *
    ...
    /**
     * Get the API endpoint for a given activity registry type.
     *
