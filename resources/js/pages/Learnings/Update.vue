...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: props.learning.title, href: route('learnings.show', { learning: props.learning.id }) },
    { title: `Edit ${props.learning.title}`, href: route('learnings.edit', { learning: props.learning.id }) },
]
</script>
