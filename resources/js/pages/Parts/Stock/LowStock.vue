...
const currentPage = ref(props.parts.current_page)

const pagination = reactive({
    current_page: props.parts.current_page,
    last_page: props.parts.last_page,
...
function goToPage(page: number) {
    if (page >= 1 && page <= pagination.last_page) {
        window.location.href = route('parts.stock.low', { page })
    }
}
</script>
